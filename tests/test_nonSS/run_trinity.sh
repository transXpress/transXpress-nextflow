...
/lab/solexa_weng/testtube/nextflow/nextflow-19.02.0-edge-all run transXpress-trinity.nf -samples 'samples.txt' -profile test_nonSS -resume 1>>transXpress-trinity.stdout.log 2>transXpress-trinity.stderr.log &
disown
