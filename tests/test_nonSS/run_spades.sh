...
/lab/solexa_weng/testtube/nextflow/nextflow-19.02.0-edge-all run transXpress-rnaspades.nf -profile test_nonSS -resume 1>>transXpress-rnaspades.stdout.log 2>transXpress-rnaspades.stderr.log &
disown
