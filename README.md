...
~~~
3. Install deeploc (performance being by transXpress developers evaluated in comparison to SingalP 4.1/5.0)
...
4. Install SignalP 4.1g (performance being by transXpress developers evaluated in comparison to SingalP 5.0/deeploc)
      * Download deeploc from http://www.cbs.dtu.dk/cgi-bin/sw_request?signalp+4.1


5. Install SignalP 5.0 (performance being by transXpress developers evaluated in comparison to SingalP 4.1/deeploc)
